...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWndEx)
	...
	ON_COMMAND(ID_EDIT_TREE1SEED, &CMainFrame::OnEditTree1seed)
	ON_COMMAND(ID_EDIT_TREE2SEED, &CMainFrame::OnEditTree2seed)
	ON_COMMAND(ID_EDIT_TREE2PROPERTIES, &CMainFrame::OnEditTree2properties)
END_MESSAGE_MAP()
...
/** Handle Tree properties changes */
void CMainFrame::OnEditTreeproperties()
{
	mPicture->GetTreeOne()->ShowDialogBox();
	
}

/** Handle Tree 2 properties changes */
void CMainFrame::OnEditTree2properties()
{
	mPicture->GetTreeTwo()->ShowDialogBox();
}

/** Change tree 1 seed */
void CMainFrame::OnEditTree1seed()
{
	mPicture->GetTreeOne()->ShowSeedDialogBox();
	// TODO: Add your command handler code here
}

/** Change tree 2 seed */
void CMainFrame::OnEditTree2seed()
{
	mPicture->GetTreeTwo()->ShowSeedDialogBox();
	// TODO: Add your command handler code here
}
